...
var Montserrat = "debd10e57fb07dd2.ttf";

var OpenSans = "ecdf1d58c0932a77.ttf";

const GlobalStyle$1 = ft`
  @font-face {
...
const Alert = ({
  ...
  const alertStyles = {
    default: {
      ...
      icon: /*#__PURE__*/React.createElement(FiCheck, null),
      textColor: "#000000"
    },
    defaultDark: {
      borderGradient: "linear-gradient(90deg, #00c0ff, #635BE7, #a000ff)",
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GlobalStyle$1, null), /*#__PURE__*/React.createElement(AlertStyled, {
  ...
  }, IconComponent || icon), /*#__PURE__*/React.createElement("h2", null, title), /*#__PURE__*/React.createElement("p", null, body)));
};
Alert.propTypes = {
  title: PropTypes.string.isRequired,
  body: PropTypes.string.isRequired,
  status: PropTypes.oneOf(["default", "primary", "success", "warning", "defaultDark", "primaryDark", "successDark", "warningDark"]).isRequired
};
...
const Button = ({
  ...
  if (path) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GlobalStyle, null), /*#__PURE__*/React.createElement(MarkBox, {
      borderGradient: borderGradient
...
const Overlay = dt.div`
  ...
  display: ${({
  isOpen
}) => isOpen ? "flex" : "none"}; /* Changed to flex */
...
function AlertDialog({
  ...
  path,
  btnColor,
  // Added btnColor to destructured props
  onClick,
  type
}) {
...
AlertDialog.propTypes = {
  ...
  // btnColor is required
  alertType: PropTypes.oneOf(["default", "primary", "success", "warning", "defaultDark", "primaryDark", "successDark", "warningDark"]).isRequired,
